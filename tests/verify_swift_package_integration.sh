...
assert_contains ".github/workflows/moltenvk-spm-ci.yml" "test -d Artifacts/MoltenVK.xcframework"
assert_contains ".github/workflows/moltenvk-spm-ci.yml" "test -d Artifacts/MoltenVK-static.xcframework"
