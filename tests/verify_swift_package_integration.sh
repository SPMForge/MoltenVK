...
assert_contains "SwiftPackage/release.config.cjs" "name: \"main\""
assert_contains "SwiftPackage/release.config.cjs" "prerelease: \"alpha\""
...
assert_contains ".github/workflows/moltenvk-spm-release.yml" "gh release create"
